...
class Ad
{
     ...
     * @Assert\Length(min=10, max=255, minMessage="Le titre doit faire plus de 10 caractères !", maxMessage="Le titre ne peut pas faire plus de 255 caratères")
     */
    private $title;
     ...
     * @Assert\Length(min=20, minMessage="Votre intrduction doit faire plus de 20 caractères !")
     */
    private $introduction;

    /**
     * @ORM\Column(type="text")
     * @Assert\Length(min=100, minMessage="Votre intrduction ne peut pas faire moins de 100 caractères !")
     */
    private $content;
